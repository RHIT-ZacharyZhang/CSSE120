...
def test_wait_for_prime():
    ...
    print('--------------------------------------------------')
    num = wait_for_prime()
    print('Entered: 45,18,6,21,22,13', 'stopped at', num)
    num2 = wait_for_prime()
    print('Entered: 6,8,10,12,14,15,17', 'stopped at', num2)
...
def test_wait_for_90th_percentile():
    ...
    expected_result = 221  # This is the expected result in Python 3.4.
