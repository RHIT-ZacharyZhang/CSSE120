...
def test_problem4a():
    ...
    #
    # NOTE: Be sure to test the  ** RETURNED VALUE **  from problem4a.
    # ------------------------------------------------------------------
    point = rg.Point(30, 30)
    window = rg.RoseWindow(300, 200, 'Problem4a, Test 1: 6 lines')
    total = problem4a(window, point, 6)
    print('Returned, expected:', total, 36)
    window.close_on_mouse_click()

    point = rg.Point(30, 30)
    window = rg.RoseWindow(450, 300, 'Problem4a, Test 2: 20 lines')
    total = problem4a(window, point, 20)
    print('Returned, expected:', total, 218)
    window.close_on_mouse_click()
...
def problem4a(window, point, n):
    ...
    (See  problem4a_picture.pdf  for two test cases you can use for this.)
    ...
    total = 0
    for k in range(n):
        point1 = rg.Point(x + 20 * k, y + 10 * k)
        point2 = rg.Point(x + 20 * k, (y + 50) + 10 * k)
...
def test_problem4b():
    ...
    print('The value returned should be: 539')
    print('The value returned is in fact:', result)
...
def problem4b(m, point1):
    ...
    # ------------------------------------------------------------------
    window = rg.RoseWindow(400, 600, 'Problem 4b')
    total = 0
    for k in range(m):
        n = 2 * k + 3
        m = problem4a(window, point1, n)
        total = total + m
