...
def sum_powers(n, p):
    ...
    Preconditions: n is a non-negative integer and p is a number.
    """
    # ------------------------------------------------------------------
...
def test_sum_powers_in_range():
    ...
    print(sum_powers_in_range(3, 100, 0.3))
    print(sum_powers_in_range(3, 100, 0.6))
