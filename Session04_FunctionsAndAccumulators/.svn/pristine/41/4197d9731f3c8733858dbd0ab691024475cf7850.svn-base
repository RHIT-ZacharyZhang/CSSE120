...
def four_dots():
    """
    1. Constructs a RoseWindow that is 300 x 300.
    ...
    for k in range(4):  # 4 points
        # --------------------------------------------------------------
        # Theta (below) is the angle in radians.  Becuase there are
        # 4 points (note the  4  in the statement below), those angles
        # are the radians equivalent of 0, 90, 180, and 270 degrees.
        # --------------------------------------------------------------
        theta = k * 2 * math.pi / 4  # theta is the angle in radians

        # Convert from polar coordinates to x/y (cartesian) coordinates.
