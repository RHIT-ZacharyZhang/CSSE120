...
def test_sum_sequence():
    ...
    print('Testing:   sum_sequence([48, -10])')
    ...
    print('Testing:   sum_sequence([48, 180, -47.5, 20.5, 88])')
    print('  Expected (oracle) result: ', oracle_answer)
    print('  Actual result:            ', actual_answer)
...
def test_count_items_bigger_than():
    ...
    sequence1 = [52, -10]
    threshold = 50
    actual_answer = count_items_bigger_than(sequence1, threshold)
    expected = 1
    print('Testing:   count_items_bigger_than([52,-10])')
    print('  Expected (oracle) result: ', expected)
    print('  Actual result:            ', actual_answer)

    sequence1 = [52, -10, 60, 80, 40]
    threshold = 50
    actual_answer = count_items_bigger_than(sequence1, threshold)
    expected = 3
    print('Testing:   count_items_bigger_than([52, -10, 60, 80, 40])')
    print('  Expected (oracle) result: ', expected)
    print('  Actual result:            ', actual_answer)
...
def test_count_positive_sines():
    ...
    print('--------------------------------------------------')
    sequence1 = [3, 4, 5, 6, 7, 8, 9]
    actual_answer = count_positive_sines(sequence1)
    print('Testing sum_sequence([3,4,5,6,7,8,9]). ')
    print('Actual, Expected =', actual_answer, 4)

    sequence2 = [3, 6, 8]
    actual_answer = count_positive_sines(sequence2)
    print('Testing sum_sequence([3,6,8]). ')
    print('Actual, Expected =', actual_answer, 2)
...
def test_sum_first_n():
    ...
    print('--------------------------------------------------')
    sequence1 = [48, -10, 30, 10]
    n = 2
    actual_answer = sum_first_n(sequence1, n)
    print('Testing sum_sequence([48, -10, 30, 10]), for n = 2. ')
    print('Actual, Expected =', actual_answer, 38)

    sequence2 = [4, 8, 12, 15, 50]
    n = 3
    actual_answer = sum_first_n(sequence2, n)
    print('Testing sum_sequence([4,8,12,15,50]), for n = 3. ')
    print('Actual, Expected =', actual_answer, 24)
