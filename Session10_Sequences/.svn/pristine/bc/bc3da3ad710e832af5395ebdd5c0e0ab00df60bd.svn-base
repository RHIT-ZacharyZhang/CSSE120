...
def main():
    ...
    # ------------------------------------------------------------------
    # TODO 2: EXAMINE the  4  sequences immediately below this comment.
    #         For all but one of the functions that you will implement,
    #         the test cases (which we supplied) run your function on
    #         sequence1, then sequence2, then sequence3, then sequence4.
    #
    # When you have absorbed this note and examined the 4 sequences below,
    # asking questions as needed, THEN:
    #
...
def print_all_items_backwards(sequence):
    ...
    for k in range(len(sequence)):
        item = sequence[len(sequence) - k - 1]
        print(item)
...
def print_items_that_are_odd_integers(sequence):
    ...
    # HINT: The  type  function returns  int  (NO quotes) if its
