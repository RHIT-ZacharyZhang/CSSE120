...
def test_problem1a():
    ...
    # ------------------------------------------------------------------
    test2 = [50, 23, 90, 56, 33, 50, 60, 80]
    mutated2 = [50, 23, 50, 33, 56, 90, 60, 80]
    print()
    print('Before the mutation:', test2)
    problem1a(test2)
    print('After the mutation: ', test2)
    print('The above should be:', mutated2)
    if test2 == mutated2:
        print('PASSED the test.')
    else:
        print('FAILED the test!')
    ...
    test3 = [50, 77, 40, 3, 90, 10, 30, 80]
    mutated3 = [50, 30, 10, 3, 90, 40, 77, 80]
    print()
    print('Before the mutation:', test3)
    problem1a(test3)
    print('After the mutation: ', test3)
    print('The above should be:', mutated3)
    if test3 == mutated3:
        print('PASSED the test.')
    else:
        print('FAILED the test!')
...
def problem1a(list_of_integers):
    ...
    then after this function call that list of integers is mutated into:
      [50, 30, 10,0]
    because 50 i 3, 90, 40, 77, 8s compared to 80,
    ...
    for k in range(n // 2):
        first = list_of_integers[k]
        if first > list_of_integers[n - 1 - k]:
            list_of_integers[k] = list_of_integers[n - 1 - k]
            list_of_integers[n - 1 - k] = first
...
def problem1b(min_x, max_x, min_y, max_y, max_radius):
    ...
    r = random.randrange(1, max_radius + 1)
