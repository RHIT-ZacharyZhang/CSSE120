...
def test_make_simple_list():
    ...
    print('--------------------------------------------------')
    print(make_simple_list(5, 13))
    print(make_simple_list(6, 14))
...
def test_make_simple_string():
    ...
    print('--------------------------------------------------')
    print(make_simple_string(5, 13))
    print(make_simple_string(6, 14))
...
def test_make_less_simple_string():
    ...
    print('--------------------------------------------------')
    print(make_less_simple_string(5, 13))
    print(make_less_simple_string(205, 205))
...
def rectangles_from_circles(circles):
    ...
    for k in circles:
        ...
        x = k.center.x
        y = k.center.y
        rectangle = rg.Rectangle(rg.Point(x - r, y - r), rg.Point(x + r, y + r))
