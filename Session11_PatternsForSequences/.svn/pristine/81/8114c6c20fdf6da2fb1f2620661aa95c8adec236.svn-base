...
#
#   When you Feel that you can at least RECOGNIZE the VARIOUS PATTERNS
#   (and can thus return to these examples as needed for details),
#    then
...
def main():
    ...
    print()
    print('Example 1: The item IS in the sequence:')
    find([88, 232, 8.5, -11, 'Grandmother', 22, 'mother', 9.0, 7.0])

    print()
    print('Example 2: The item is NOT in the sequence:')
    find([1, 2, 5])
...
def find(sequence):
    ...
    print('FINDING the first STRING in the sequence:')
    print('   ', sequence)
    print('  -- Found?', answer1)
