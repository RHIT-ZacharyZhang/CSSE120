...
#    that is (per the green doc-strings) it prints a slang greeting,
#    then inputs the radius of a circle and prints the circle's area.
# ----------------------------------------------------------------------
...
def circle_area():
    """
    Prompts for and inputs the radius of a circle
    and prints a message that indicates the circle's area.
    """
