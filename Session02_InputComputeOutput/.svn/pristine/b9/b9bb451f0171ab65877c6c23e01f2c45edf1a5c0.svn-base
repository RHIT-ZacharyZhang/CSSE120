...
It demonstrates:
  ...
  -- How to INPUT a number using:
       ...
       -- a variable (i.e., name) in which to store the number,
...
Authors: Susan Computewell (aka John Zelle), modified by David Mutchler,
         Amanda Stouder, Chandan Rupakheti, Claude Anderson, Katie Dion,
         Delvin Defoe, Curt Clifton and their colleagues. December 2013.
"""
# ----------------------------------------------------------------------
