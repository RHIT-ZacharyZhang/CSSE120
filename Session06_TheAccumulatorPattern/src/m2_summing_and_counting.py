...
def test_sum_more_cosines():
    ...
    #   Include at least 3 tests.  (We suppplied one of them for you.)
    # ------------------------------------------------------------------
    print()
    print('--------------------------------------------------')
    ...
    print('Returned, expected:', answer1, 0.13416)
    answer2 = sum_more_cosines(-4 , 2)
    print('Returned, expected:', answer2, -0.39533)
    answer3 = sum_more_cosines(10 , 20)
    print('Returned, expected:', answer3, 1.117984)
...
def test_count_sines_from():
    ...
    #   function. Write the two functions in whichever order you prefer.
    #   Include at least 4 tests.  (We supplied one of them for you.)
    # ------------------------------------------------------------------
    print()
    print('--------------------------------------------------')
    ...
    answer1 = count_sines_from(3, 9)
    print('Returned, expected:', answer1, 5)
    answer2 = count_sines_from(4, 6)
    print('Returned, expected:', answer2, 3)
    answer3 = count_sines_from(7, 9)
    print('Returned, expected:', answer3, 1)
    answer4 = count_sines_from(8, 9)
    print('Returned, expected:', answer4, 1)
...
def test_count_sines_vs_cosines():
    ...
    answer1 = count_sines_vs_cosines(101)
    print('Returned, expected:', answer1, 100)
    answer2 = count_sines_vs_cosines(5)
    print('Returned, expected:', answer2, 6)
    answer3 = count_sines_vs_cosines(3)
    print('Returned, expected:', answer3, 4)
    answer4 = count_sines_vs_cosines(0)
    print('Returned, expected:', answer4, 0)
